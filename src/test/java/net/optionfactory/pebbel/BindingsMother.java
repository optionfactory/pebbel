...
public class BindingsMother {
    ...
    private static final Map<String, VariableDescriptor> VARIABLE_DESCRIPTORS = new HashMap<>();
    
     static {
         VARIABLE_VALUES.put("VAR1", new Object());
         VARIABLE_DESCRIPTORS.put("VAR1", VariableDescriptor.of("VAR1", Object.class, "help for VAR1", "source name", 0));
     }
     ...
     private static final Bindings<String, Object, VariableDescriptor> VARS = Bindings.root(VARIABLE_VALUES, VARIABLE_DESCRIPTORS);
     
     public static final Symbols SYMBOLS = Symbols.of(FUNCTIONS, VARS);
     public static final Descriptors DESCRIPTORS = Descriptors.from(SYMBOLS);
